          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div
                ...
                className="group cursor-pointer bg-white p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl shadow-2xl border-2 border-transparent hover:border-afriviral-blue-300 transition-all duration-300 hover:shadow-3xl hover:-translate-y-1 sm:hover:-translate-y-3"
              >
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-blue rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-6 sm:mb-8 group-hover:scale-110 transition-transform duration-300">
                  <BuildingOfficeIcon className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Je suis une PME</h3>
              ...
              <div
                ...
                className="group cursor-pointer bg-white p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl shadow-2xl border-2 border-transparent hover:border-afriviral-orange-300 transition-all duration-300 hover:shadow-3xl hover:-translate-y-1 sm:hover:-translate-y-3"
              >
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-orange rounded-2xl sm:rounded-3xl flex items-center justify-center mx-auto mb-6 sm:mb-8 group-hover:scale-110 transition-transform duration-300">
                  <UserGroupIcon className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Je suis Influenceur</h3>
                <p className="text-gray-600 mb-6 sm:mb-8 leading-relaxed text-base sm:text-lg">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6 sm:mb-8">
              <button
                ...
                className="flex items-center gap-2 text-gray-500 hover:text-gray-700 transition-colors group self-start"
              >
                <ArrowLeftIcon className="h-4 w-4 sm:h-5 sm:w-5 group-hover:-translate-x-1 transition-transform" />
                <span className="text-sm sm:text-base">Retour au choix</span>
              </button>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-primary rounded-xl sm:rounded-2xl flex items-center justify-center">
